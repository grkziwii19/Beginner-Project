...
import {
  Users, BookOpen, CalendarCheck, Star, ClipboardList, Download,
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const fetchAll = async () => {
      ...
      // Cek status onboarding — kalau belum lengkap, arahkan ke /onboarding
  ...
  const quickActions = [
    ...
    { label: 'Absensi Hari Ini', sub: 'Catat kehadiran', icon: CalendarCheck, color: 'bg-emerald-600', href: '/classes' },
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2">
          <Link href="/classes" className="btn-secondary text-sm">
            <ClipboardList className="w-4 h-4" /> Rekap Absen
          </Link>
