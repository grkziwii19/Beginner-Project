...
import {
  ...
  ChevronDown, UserCircle, LogOut, Bot, Sparkles
} from 'lucide-react'
        ...
        <div className="p-3 mt-1 border-t border-slate-800 space-y-2.5">
          ...
          <div className="relative">
            <div
              ...
              className="flex items-center gap-2.5 w-full px-1 py-1.5 rounded-lg hover:bg-slate-800 transition-colors cursor-pointer select-none"
            >
