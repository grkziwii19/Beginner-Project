    ...
    return (
      <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 text-center">
          ...
          <h3 className="font-semibold text-slate-900 mb-1">Hapus kelas "{classItem.name}"?</h3>
          <p className="text-sm text-slate-500 mb-5">
            Siswa di kelas ini tidak ikut terhapus, namun perlu dipindahkan ke kelas lain secara manual.
          </p>
          <div className="flex gap-3">
            <button onClick={() => setDeleteConfirm(false)} className="btn-secondary flex-1 justify-center">Batal</button>
    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[90vh] flex flex-col">
        ...
        <div className="p-5 overflow-y-auto flex-1">
          <ClassForm data={form} onChange={setForm} />
